...
from .constants import (
    ...
    MINIMUM_CSRF_TOKEN_AGE,
    MAXIMUM_CSRF_TOKEN_AGE,
    PATTERNS,
    ERROR_MESSAGES,
)
...
class CSRFTokenInfo:
    ...
    def is_expired(self) -> bool:
        """Check if the token is expired based on default max age."""
        return self.age_seconds > DEFAULT_CSRF_TOKEN_MAX_AGE
...
def generate_csrf_token(
    ...
    if user_data:
        ...
        user_data_b64 = base64.urlsafe_b64encode(user_data_json.encode('utf-8')).decode('ascii').rstrip('=')
    else:
        user_data_b64 = ""
...
def generate_double_submit_token(
    ...
    cookie_b64 = base64.urlsafe_b64encode(cookie_json.encode('utf-8')).decode('ascii').rstrip('=')
...
def generate_encrypted_csrf_token(
    ...
    # Base64 encode
    encrypted_b64 = base64.urlsafe_b64encode(encrypted_bytes).decode('ascii').rstrip('=')
