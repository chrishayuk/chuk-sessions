...
help:
	...
	@echo "  dev-install-all - Install with all optional dependencies (includes Redis)"
	@echo "  test           - Run tests"
...
dev-install:
	...
	@echo ""
	@echo "Optional: Install Redis support with:"
	@echo "  pip install -e \".[redis]\""
	@echo ""
...
publish-test: build
	...
	echo ""; \
	echo "Install with:"; \
	echo "  pip install --index-url https://test.pypi.org/simple/ chuk-sessions==$$version"
...
publish-manual: build
	...
	echo "Install with: pip install chuk-sessions==$$version"
