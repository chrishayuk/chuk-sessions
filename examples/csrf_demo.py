...
def demo_token_info_extraction():
    ...
    print_result("Simple token (requires user data)", requires_data_fail, not requires_data_fail)
...
def demo_real_world_scenario():
    ...
    profile_token = generate_csrf_token(user_session, app_secret, user_data=profile_data)
    ...
    transfer_cookie, transfer_form = generate_double_submit_token(user_session, app_secret)
    ...
    print("\n   API call validation:")
    api_valid, api_extracted = validate_encrypted_csrf_token(api_token, user_session, app_secret)
    ...
    replay_result = validate_csrf_token(old_token, user_session, app_secret, max_age_seconds=3600)
